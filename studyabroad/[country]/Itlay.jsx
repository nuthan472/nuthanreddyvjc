...
const StudyInItaly = () => {
  return (
    <div style={{ fontFamily: "Times New Roman", padding: "20px", lineHeight: "1.6", fontSize: "18px" }}>
      <h1 className="text-2xl font-bold mb-4">
        <span style={{ color: "orange" }}>VJC Overseas</span>: Study in Italy – Your Gateway to World-Class Education
      </h1>

      <p>Welcome to <span style={{ color: "orange" }}>VJC Overseas</span>, your trusted partner in making your dream of studying in Italy come true. Italy, renowned for its rich history, culture, and exceptional education system, offers a world-class education experience that attracts students globally.</p>
      ...
      <h2>• Top Italian Universities & Colleges</h2>
      <ul>
      ...
      <h2>• Tuition Fees</h2>
      <ul>
        <li>• Undergraduate Programs: €1,000 - €4,000 per year</li>
        <li>• Postgraduate Programs: €1,500 - €4,500 per year</li>
        <li>• Ph.D. Programs: €2,000 - €5,000 per year</li>
        <li>• Language Courses: €300 - €1,000 per semester</li>
      </ul>

      <h2>• Living Expenses</h2>
      <p>• Estimated cost of living in Italy ranges from €700 to €1,000 per month, covering accommodation, food, and transportation.</p>
      ...
      <p>
        Ready to study in Italy? <span style={{ color: "orange" }}>VJC Overseas</span> is here to guide you. Contact us today to learn more about study opportunities in Italy, available scholarships, and how we can help you achieve your academic goals.
      </p>
    </div>
  );
};
