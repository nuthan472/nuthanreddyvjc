  ...
  return (
    <div style={{ fontFamily: "Times New Roman, Times, serif", padding: "20px", lineHeight: "1.8", fontSize: "18px" }}>
      ...
      <p style={{ marginBottom: "20px" }}>
        At <span style={{ color: "orange" }}>VJC Overseas</span>, we understand that embarking on a career journey in the UAE
      ...
      <h2 style={{ fontWeight: "bold", marginTop: "30px" }}>What is the UAE Jobseeker Visa?</h2>
      <p style={{ marginBottom: "20px" }}>
      ...
      <h2 style={{ fontWeight: "bold", marginTop: "30px" }}>Benefits of the UAE Jobseeker Visa</h2>
      ...
      <h2 style={{ fontWeight: "bold", marginTop: "30px" }}>UAE Jobseeker Visa – Processing Time</h2>
      <p style={{ marginBottom: "20px" }}>
      ...
      <h2 style={{ fontWeight: "bold", marginTop: "30px" }}>Visa Fees</h2>
      <ul style={{ marginBottom: "20px" }}>
      ...
      <p>Additional processing fees, medical checks, and health insurance may apply.</p>
      
      <h2 style={{ fontWeight: "bold", marginTop: "30px" }}>Living Expenses in the UAE</h2>
      <h3 style={{ fontWeight: "bold", marginTop: "20px" }}>Accommodation</h3>
      <ul>
      ...
      <h3 style={{ fontWeight: "bold", marginTop: "20px" }}>Utilities</h3>
      <p>Electricity, water, and cooling bills: AED 300 to AED 600/month</p>

      <h3 style={{ fontWeight: "bold", marginTop: "20px" }}>Food & Groceries</h3>
      <ul>
      ...
      <h3 style={{ fontWeight: "bold", marginTop: "20px" }}>Transportation</h3>
      <ul>
      ...
      <h2 style={{ fontWeight: "bold", marginTop: "30px" }}>Lifestyle in the UAE</h2>
      <ul style={{ marginBottom: "20px" }}>
      ...
      <h2 style={{ fontWeight: "bold", marginTop: "30px" }}>Why Choose <span style={{ color: "orange" }}>VJC Overseas</span>?</h2>
      <p>
        At <span style={{ color: "orange" }}>VJC Overseas</span>, we are committed to helping you navigate the UAE Jobseeker Visa process smoothly and efficiently.
      </p>
      
      <h2 style={{ fontWeight: "bold", marginTop: "30px" }}>Ready to start your journey?</h2>
      <p>
