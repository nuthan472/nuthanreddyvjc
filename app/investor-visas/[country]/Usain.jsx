  ...
  return (
    <div style={{ 
      ...
      <p>
        ...
        and live in the United States. One of the most popular options is the <strong>EB-5 Immigrant Investor Visa Program</strong>.
        This program allows eligible foreign nationals to obtain a U.S. Green Card (Permanent Residency) by making a qualifying
        investment in a U.S. business that creates or preserves jobs for U.S. workers.
      </p>
      <p>
        At <span style={{ color: "orange" }}>VJC Overseas</span>, we provide expert guidance and support to investors navigating the complexities of the EB-5 visa process,
        ensuring a smooth and successful immigration journey.
      </p>
      
      <h2>Key Features of the USA Investor Visa (EB-5)</h2>
      <ul>
      ...
      <h2>USA Investor Visa Eligibility Requirements</h2>
      <ul>
      ...
      <h2>Document Checklist for USA Investor Visa</h2>
      <ul>
      ...
      <h2>Why Choose <span style={{ color: "orange" }}>VJC Overseas</span> for Your USA Investor Visa?</h2>
      <ul>
      ...
      <h2>Start Your USA Investor Visa Journey Today!</h2>
      <p>
        Contact us today for a personalized consultation and take the first step toward securing your U.S. residency
        through the EB-5 Investor Visa Program. Let <span style={{ color: "orange" }}>VJC Overseas</span> help you make your investment in the American Dream a reality!
      </p>
      
      <p><strong>Disclaimer:</strong> The content provided above is for informational purposes only and should not be considered legal advice. Please consult with an immigration attorney for specific guidance on your case.</p>
    </div>
  );
};
