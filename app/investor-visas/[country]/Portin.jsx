...
const PortugalInvestorVisa = () => {
  return (
    <div style={{ 
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">Why Choose Portugal for Investment and Residency?</h2>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">Investment Options for the Portugal Investor Visa</h2>
      <ul className="list-disc pl-6 mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">Benefits of the Portugal Investor Visa</h2>
      <ul className="list-disc pl-6 mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">Why <span className="text-orange-500">VJC Overseas</span>?</h2>
      <ul className="list-disc pl-6 mb-4">
      ...
      <div className="text-center mt-8">
        <h2 className="text-2xl font-bold text-orange-500">Get Started Today</h2>
        <p className="mt-4">
