...
const StudyInNorway = () => {
  return (
    <div className="p-6 max-w-5xl mx-auto text-justify">
      ...
      <h2 className="text-2xl font-semibold mt-6" style={{ fontFamily: 'Times New Roman' }}>Why Study in Norway?</h2>
      ...
      <h2 className="text-2xl font-semibold mt-6" style={{ fontFamily: 'Times New Roman' }}>Cost of Studying in Norway: Fees Breakdown</h2>
      <ul className="list-disc pl-6 text-lg" style={{ fontFamily: 'Times New Roman' }}>
      ...
      <h2 className="text-2xl font-semibold mt-6" style={{ fontFamily: 'Times New Roman' }}>Scholarships and Financial Aid</h2>
      ...
      <h2 className="text-2xl font-semibold mt-6" style={{ fontFamily: 'Times New Roman' }}>Apply Now with <span style={{ color: 'orange' }}>VJC Overseas</span></h2>
      <p className="text-lg" style={{ fontFamily: 'Times New Roman' }}>
